        ...
        <NavigationMenu className="flex items-center space-x-4">
          ...
          <div className="ml-auto">
            <label className="swap swap-rotate">
              ...
              {/* Sun Icon (smaller size) */}
              <svg
                className="swap-off h-6 w-6 fill-current"  // Adjusted size to h-6 w-6
              ...
              {/* Moon Icon (smaller size) */}
              <svg
                className="swap-on h-6 w-6 fill-current" // Adjusted size to h-6 w-6
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
                <path
